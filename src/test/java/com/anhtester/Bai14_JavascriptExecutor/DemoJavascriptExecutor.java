...
public class DemoJavascriptExecutor extends BaseTest {
    ...
    public void jsExecutorDemo04() throws InterruptedException {
        ...
        js.executeScript("arguments[0].style.border='2px solid blue'", inputEmail);
        inputEmail.sendKeys("admin@example.com");
        Thread.sleep(1000);
        WebElement inputPassword = driver.findElement(By.xpath("//input[@id='password']"));
        js.executeScript("arguments[0].style.border='2px solid yellow'", inputPassword);
        inputPassword.sendKeys("123456");
        Thread.sleep(1000);
        WebElement buttonLogin = driver.findElement(By.xpath("//button[normalize-space()='Login']"));
        js.executeScript("arguments[0].style.border='2px solid red'", buttonLogin);
        inputEmail.click();
